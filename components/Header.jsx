      ...
      <div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 items-center gap-5">
          {session ? (
            ...
            <button
              type="button"
              className="text-sm text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg hover:underline underline-offset-4 px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 ml-2"
