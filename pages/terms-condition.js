export default function TermsCondition() {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <p>
        This website is operated by Nazaakat Clothing. Throughout the site, the
        terms “we”, “us” and “our” refer to Nazaakat Clothing. Nazaakat Clothing
      ...
      <p className="mb-8">
        ...
        our Privacy Policy. To view our Privacy Policy click{" "}
      ...
      <p className="mb-4">
        In no case shall Nazaakat Clothing, our directors, officers, employees,
      ...
      <p className="mb-4">
        You agree to indemnify, defend and hold harmless Nazaakat Clothing and
      ...
      <p className="mb-4">
        ...
        laws of [Your Country], [Your State/Country].
      </p>
