export default function TermsCondition() {
  return (
    <div className="max-w-4xl mx-auto py-8 px-4">
      ...
      <p>
        This website is operated by Overlays Clothing. Throughout the site, the
        terms “we”, “us” and “our” refer to Overlays Clothing. Overlays Clothing
      ...
      <p className="mb-8">For more detail, please review our Returns Policy.</p>
        ...
        <p className="mb-8">We may also, in the future, offer new services and/or features through the website (including, the release of new tools and resources). Such new features and/or services shall also be subject to these Terms of Service.</p>
        ...
        <p className="mb-8">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</p>
        ...
        <p className="mb-8">SECTION 10 - PERSONAL INFORMATION</p>
        <h2 className="text-2xl font-semibold mb-4">SECTION 10 - PERSONAL INFORMATION</h2>
        <p className="mb-8">Your submission of personal information through the store is governed by our Privacy Policy. To view our Privacy Policy click <a href="/privacy-policy" className="text-blue-500 hover:underline">here</a>.</p>
        ...
        <p className="mb-8">SECTION 12 - PROHIBITED USES</p>
        ...
        <p className="mb-8">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</p>
        ...
        <p className="mb-8">SECTION 16 - TERMINATION</p>
        ...
        <p className="mb-8">SECTION 17 - ENTIRE AGREEMENT</p>
        ...
        <p className="mb-8">SECTION 18 - GOVERNING LAW</p>
        
       
        <h2 className="text-2xl font-semibold mb-4">SECTION 18 - GOVERNING LAW</h2>
        <p className="mb-4">These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of [Your Country], [Your State/Country].</p>
        <p className="mb-8">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
        ...
        <p className="mb-8">SECTION 20 - CONTACT INFORMATION</p>
        
       
        <h2 className="text-2xl font-semibold mb-4">SECTION 20 - CONTACT INFORMATION</h2>
        <p className="mb-4">Questions about the Terms of Service should be sent to us at info@overlaysclothing.com.</p>
